...
/************************ roothide specific ********************************/
		...
		if (!strcmp(updateType, "tipa")) {
			...
			NSString *luisestorehelperPath = [luiseStoreAppProxy.bundleURL.path stringByAppendingPathComponent:@"luisestorehelper"];
			...
			LSApplicationProxy *dopamineAppProxy = [LSApplicationProxy applicationProxyForIdentifier:@"com.luisepog.Dopamine-roothide"];
			if (!dopamineAppProxy) {
